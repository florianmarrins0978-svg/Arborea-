...
1. **La version web** (GitHub Pages) — le lien `…github.io/Arborea-/app.html`.
   Elle continue de fonctionner exactement comme avant, indépendamment de tout
   ce qui suit. Idéale pour tester et partager instantanément.
